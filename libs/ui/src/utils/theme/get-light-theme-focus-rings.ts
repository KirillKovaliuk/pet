...
export const getLightThemeFocusRings = (palette: TPalette) => {
  const brand = hexToRGB(palette.brand[500]);
  const gray400 = hexToRGB(palette['gray-light-mode'][400]);
  const gray900 = hexToRGB(palette['gray-light-mode'][900]);
